...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -704.77247968838; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 223.43784792279013; // x position of the perpendicular encoder (in tick units)
    }
